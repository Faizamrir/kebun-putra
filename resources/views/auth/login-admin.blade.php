<x-guest-layout>
    ...
    <form method="POST" class="space-y-4 md:space-y-6" action="{{ route('admin-login') }}">
        ...
        <div>
            ...
            <button class="w-full text-white bg-lime-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-400 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                {{ __('Sign In') }}
            </button>
        </div>
    </form>
